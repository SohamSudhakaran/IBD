...
results2 <- results %>%
  mutate(Significance = case_when(Odds_ratio >= odds_ratio_threshold_upper & fdr < fdr_threshold ~ "Upregulated", Odds_ratio <= (odds_ratio_threshold_lower) & fdr < fdr_threshold ~ "Downregulated", TRUE ~ "Not Significant"))
```
<!---
```{r}
# Create volcano plot
